...
BEGIN
    CREATE TABLE [dbo].[users] (
        ...
        [role] NVARCHAR(50) NOT NULL DEFAULT 'DOCTOR', -- ADMIN, DOCTOR, NURSE, PHARMACIST, LAB_TECH, BILLING
...
BEGIN
    CREATE TABLE [dbo].[doctors] (
        ...
        [full_name] NVARCHAR(100) NOT NULL,
        [specialty] NVARCHAR(100) NOT NULL, -- Cardiology, Neurology, Orthopedics, Pediatrics, Oncology, Trauma Emergency
        [department] NVARCHAR(100) NOT NULL,
        [ward] NVARCHAR(100) NULL,
        [qualifications] NVARCHAR(255) NULL,
        [status] NVARCHAR(50) NOT NULL DEFAULT 'ON_DUTY', -- ON_DUTY, IN_SURGERY, IN_CONSULTATION, ON_LEAVE
...
BEGIN
    CREATE TABLE [dbo].[patients] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [mrn] NVARCHAR(50) NOT NULL UNIQUE, -- Medical Record Number, e.g. MRN-89421
        [full_name] NVARCHAR(100) NOT NULL,
        [national_id] NVARCHAR(50) NOT NULL,
        [date_of_birth] DATE NOT NULL,
        [gender] NVARCHAR(20) NOT NULL, -- Male, Female, Other
        [blood_group] NVARCHAR(10) NOT NULL, -- A+, A-, B+, B-, AB+, AB-, O+, O-
        ...
        [care_status] NVARCHAR(50) NOT NULL DEFAULT 'INPATIENT', -- INPATIENT, OUTPATIENT, OBSERVATION, DISCHARGED, CRITICAL_ICU
...
BEGIN
    CREATE TABLE [dbo].[appointments] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [appointment_number] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. APT-2024-001
        [patient_id] BIGINT NOT NULL,
        [doctor_id] BIGINT NOT NULL,
        [department] NVARCHAR(100) NOT NULL,
        [appointment_date_time] DATETIME2 NOT NULL,
        [appointment_type] NVARCHAR(100) NOT NULL, -- Follow-up, Routine Check, Pre-Op, Echo Review, Annual Well Check
        [status] NVARCHAR(50) NOT NULL DEFAULT 'SCHEDULED', -- SCHEDULED, CHECKED_IN, IN_CONSULT, COMPLETED, CANCELLED
...
BEGIN
    CREATE TABLE [dbo].[admissions] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [admission_number] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. ADM-99120
        [patient_id] BIGINT NOT NULL,
        [ward] NVARCHAR(100) NOT NULL, -- ICU & Critical Care, General Medical Ward, Emergency Ward (ER), Private & Semi-Private
        [bed_number] NVARCHAR(50) NOT NULL, -- e.g. ICU Bed 03, Gen Ward 4B-12, ER Bay 06
        [admission_date_time] DATETIME2 NOT NULL DEFAULT SYSUTCDATETIME(),
        [discharge_date_time] DATETIME2 NULL,
        [triage_acuity] NVARCHAR(50) NOT NULL DEFAULT 'STANDARD', -- IMMEDIATE, URGENT, STANDARD, OBSERVATION
        [attending_doctor_id] BIGINT NULL,
        [status] NVARCHAR(50) NOT NULL DEFAULT 'ADMITTED', -- ADMITTED, DISCHARGED, TRANSFERRED
...
BEGIN
    CREATE TABLE [dbo].[lab_tests] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [test_code] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. LAB-8021
        [test_name] NVARCHAR(150) NOT NULL, -- Complete Blood Count, Arterial Blood Gas, Troponin I, Lipid Panel
        [category] NVARCHAR(100) NOT NULL, -- Hematology, Biochemistry, Microbiology, Pathology, Radiology
        [patient_id] BIGINT NOT NULL,
        [doctor_id] BIGINT NOT NULL,
        [priority] NVARCHAR(50) NOT NULL DEFAULT 'ROUTINE', -- STAT_IMMEDIATE, URGENT, ROUTINE
...
BEGIN
    CREATE TABLE [dbo].[medications] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [drug_code] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. MED-RX-102
        [name] NVARCHAR(150) NOT NULL, -- e.g. Atorvastatin, Amoxicillin, Epinephrine
        [generic_name] NVARCHAR(150) NOT NULL,
        [category] NVARCHAR(100) NOT NULL, -- Cardiovascular, Antibiotic, Analgesic, Emergency, Respiratory
        [dosage_form] NVARCHAR(50) NOT NULL, -- Tablet, Injection, Syrup, Capsule, IV Infusion
        [strength] NVARCHAR(50) NOT NULL, -- 20mg, 500mg, 1mg/ml
...
BEGIN
    CREATE TABLE [dbo].[billings] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [invoice_number] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. INV-2024-884
        [patient_id] BIGINT NOT NULL,
        ...
        [payment_status] NVARCHAR(50) NOT NULL DEFAULT 'PENDING', -- PAID, PENDING, PARTIAL, OVERDUE
        [payment_method] NVARCHAR(50) NULL, -- Insurance Claim, Credit Card, Bank Wire, Cash
...
BEGIN
    CREATE TABLE [dbo].[staff_members] (
        [id] BIGINT IDENTITY(1,1) NOT NULL,
        [employee_id] NVARCHAR(50) NOT NULL UNIQUE, -- e.g. EMP-1049
        [full_name] NVARCHAR(100) NOT NULL,
        [role_title] NVARCHAR(100) NOT NULL, -- Head Nurse, Triage Specialist, Anesthesiologist Assistant, Admin Supervisor
        [department] NVARCHAR(100) NOT NULL,
        [shift_schedule] NVARCHAR(100) NOT NULL, -- Morning 08:00 - 16:00, Evening 16:00 - 00:00, Night 00:00 - 08:00
        [contact_number] NVARCHAR(50) NOT NULL,
        [email] NVARCHAR(100) NOT NULL,
        [status] NVARCHAR(50) NOT NULL DEFAULT 'ACTIVE', -- ACTIVE, ON_LEAVE, ON_CALL
        [avatar_url] NVARCHAR(500) NULL,
        [created_at] DATETIME2 NOT NULL DEFAULT SYSUTCDATETIME(),
        [updated_at] DATETIME2 NULL,
...
BEGIN
    CREATE TABLE [dbo].[hospital_notifications] (
        ...
        [notification_type] NVARCHAR(50) NOT NULL DEFAULT 'INFO', -- TRAUMA_ALERT, URGENT_LAB, LOW_STOCK, ADMISSION, SYSTEM
        [target_department] NVARCHAR(100) NULL,
        [priority] NVARCHAR(50) NOT NULL DEFAULT 'MEDIUM', -- CRITICAL, HIGH, MEDIUM, LOW
